...
bool DualShockJC::check_vibration_enabled() volatile
{
...
void DualShockJC::check_figure_buttons() volatile
{
...
void DualShockJC::check_fore_buttons() volatile
{
...
void DualShockJC::check_pad() volatile
{
...
void DualShockJC::get_sticks() volatile
{
    check_stick<PSS_LX, PSS_LY, PSB_L3>("Left stick", on_left_stick);
    check_stick<PSS_RX, PSS_RY, PSB_R3>("Right stick", on_right_stick);
}
